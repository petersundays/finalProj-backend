...
public class ProjectService {
    ...
    @Consumes(MediaType.MULTIPART_FORM_DATA)
    @Transactional
    public Response editProject (@HeaderParam("token") String token, @HeaderParam("id") int id, MultipartFormDataInput input, @Context HttpServletRequest request) throws IOException {
        String ipAddress = request.getRemoteAddr();
